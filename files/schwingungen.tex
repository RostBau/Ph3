...
\begin{tabular}{|p{4cm}|p{8cm}|p{6cm}|}
	...
	\begin{minipage}[]{8cm}
    \vspace{0.2cm}
	$J_A\ddot{\varphi}+m\,g\,a\sin(\varphi)=0$ $\xrightarrow{\text{lin.}}$ $J_A\ddot{\varphi}+m\,g\,a\,\varphi=0$\\ \\
	...
	bei mehreren Elementen: \quad \parbox{3cm}{
									$J_A = \sum J_{A_i}$\\
									$m = \sum m_i$}\\ \\
	Satz von Steiner: \quad \parbox{3cm}{
								$J_A=J_S+m\,a^2$ \\
								$J_M=J_S+m\,x^2$}\\ \\
